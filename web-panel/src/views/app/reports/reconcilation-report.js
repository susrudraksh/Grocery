...
if(res){
  ...
  render() {
    ...
    return (
      ...
      <Fragment>
        <div>
          <Button color="primary downloadcsv" size="xs" style={{ float: "right" }}><CSVLink data={(this.state.csvData && this.state.csvData || [])} filename={"reconcilation-analysis.csv"}><IntlMessages id="pages.download" /></CSVLink></Button>
        </div>
                        ...
                        <Colxx xxs="12" sm="6">
                            <FormGroup className="form-group has-float-label">
                              ...
                              <Field
                                ...
                                type="text"
                              />
                              {errors.physical_quantity && touched.physical_quantity ? (
                                <div className="invalid-feedback d-block">
