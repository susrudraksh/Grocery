...
class ProductCategoriesList extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      addNewItemRoute: "/app/add-product-category",
  ...
  dataListRender = async () => {
    ...
    let path =
      ApiRoutes.GET_PRODUCT_CATEGORIES +
      "?page_no=" +
  ...
  onChangePage = (page) => {
    ...
    console.log(this.props.location, "history11");
  };
    ...
    swalWithBootstrapButtonsStatus
      ...
      .then(async (result) => {
        if (result.value) {
          ...
          let path = ApiRoutes.UPDATE_PRODUCT_CATEGORY_STATUS + "/" + itemId;
  ...
  onDeleteItem = async (itemId, index) => {
    swalWithBootstrapButtonsDelete
      ...
      .then(async (result) => {
        if (result.value) {
          let path = ApiRoutes.DELETE_PRODUCT_CATEGORY + "/" + itemId;
    ...
    return this.state.isLoading ? (
      ...
      <Fragment>
        <div className="disable-text-selection">
          <ListPageHeading
            heading="menu.product-categories"
            match={match}
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              <Link
                                to={{
                                  pathname: `edit-product-category/${item._id}`,
                                  state: {
