...
class CustomizationTypeList extends Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      addNewItemRoute: "/app/add-customization-type",
  ...
  dataListRender = async () => {
    ...
    let path =
      ApiRoutes.GET_CUSTOMIZATION_TYPES +
      "?page_no=" +
    ...
    swalWithBootstrapButtonsStatus
      ...
      .then(async (result) => {
        if (result.value) {
          ...
          let path = ApiRoutes.UPDATE_CUSTOMIZATION_TYPE_STATUS + "/" + itemId;
  ...
  onDeleteItem = async (itemId, index) => {
    swalWithBootstrapButtonsDelete
      ...
      .then(async (result) => {
        if (result.value) {
          let path = ApiRoutes.DELETE_CUSTOMIZATION_TYPE + "/" + itemId;
    ...
    return this.state.isLoading ? (
      ...
      <Fragment>
        <div className="disable-text-selection">
          <ListPageHeading
            heading="menu.customization-types"
            match={match}
                        ...
                        return (
                          <tr key={index}>
                            ...
                            <td>
                              ...
                              <Link
                                to={{
                                  pathname: `edit-customization-type/${item._id}`,
                                  state: {
                              ...
                              <Button outline color="danger" size="xs" className="mb-2" onClick={(e) => this.onDeleteItem(item._id, index)}>
...
export default CustomizationTypeList;
