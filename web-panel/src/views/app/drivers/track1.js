...
class DriversTrack extends Component {
  constructor(props) {
    super(props);
                          ...
                          <tr key={index}>
                            ...
                            <td>
                              <Switch
                                ...
                                title={item.online_status ? "Deactivate" : "Activate"}
                                onChange={(e) => this.onChangeItemOnlineStatus(item._id, index, item.online_status)}
                              />
                            </td>
                            ...
                            <td>
                              ...
                              <NavLink to={`track-driver/${item._id}`}>
                                <Button outline color="info" size="xs" className="mb-2" title="Edit">
                                  <div className="glyph-icon simple-icon-note"></div>
                                </Button>
                              </NavLink>{" "}
