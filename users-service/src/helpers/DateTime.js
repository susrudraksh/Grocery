...
convertLocalToUtcByTimezone: (dateTime, timezone, format = "") => {
    ...
    return DateTime.getDateFormat(timezoneTime, format);
},
...
getCurrentDate: () => {
    ...
    var modified_dateonly = DateTime.getDateFormat(current_datetime, "yyyy-mm-dd");
...
getCurrentDateTime: () => {
    ...
    var current_datetime = new Date();
    var modified_datetime = DateTime.getDateFormat(current_datetime, "isoUtcDateTime");
...
getCurrentTime: () => {
    ...
    var current_datetime = new Date();
    var current_time = DateTime.getDateFormat(current_datetime, "HH:MM:ss");
    return current_time;
},
